...
# ## Расчёт базового репродуктивного числа R₀
γ = 1 / params[:infection_period]
β = params[:β_und][1]
R₀ = β / γ

println("Базовое репродуктивное число R₀ = ", round(R₀, digits=2))
println("Теоретический порог эпидемии: R₀ > 1 → эпидемия возможна")
println("Фактический пик инфицированных: ", round(maximum(agent_df.infected) / 3000 * 100, digits=1), "%")
# # Исследование порога возникновения эпидемии
# Находим минимальное значение β, при котором возникает значимая эпидемия.
using DrWatson
...
# ## Функция для определения пика эпидемии при заданном β

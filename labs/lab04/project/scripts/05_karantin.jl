# # Моделирование карантинных мер
# Закрытие города при превышении порога заболеваемости.
using DrWatson
...
# ## Расширенная модель с карантином
function quarantine_model(; quarantine_threshold=0.1, seed=42)
    ...
    for step in 1:150
        ...
        # Карантин: закрываем город, где превышен порог
        if !quarantined
            for city in 1:3
